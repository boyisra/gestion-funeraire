...
class LoginView:
    def __init__(self, page: ft.Page):
        ...
        self.champ_email = None
        self.champ_password = None
        self.message_erreur = None
        self.btn_connexion = None
        self.label_btn = None
    ...
    def build(self) -> ft.View:
        ...
        self.champ_email = ft.TextField(
            ...
            color=TEXT_MAIN,
            bgcolor=INPUT_BG,
            on_submit=lambda e: self.champ_password.focus() if self.champ_password else None,
        )
    ...
    def se_connecter(self, e):
        ...
        if not self.champ_email or not self.champ_password:
            return
    ...
    def _set_chargement(self, actif: bool):
        ...
        if self.btn_connexion and self.label_btn:
